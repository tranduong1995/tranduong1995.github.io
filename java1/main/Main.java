                   ...
                   case 3:
                       ...
                       for (int i = 0; i < subjectnumber; i++) {
                           ...
                           System.out.println("Nhập tổng số tiết : ");
                            subject.setToalLesson(new Scanner(System.in).nextInt()) ;

                           System.out.println("Nhập số tiết lý thuyết:");
                           subject.setTheoryLesson(new Scanner(System.in).nextInt());

                           System.out.println("Nhập mức kinh phí:");
                           subject.setPrice(new Scanner(System.in).nextDouble());
